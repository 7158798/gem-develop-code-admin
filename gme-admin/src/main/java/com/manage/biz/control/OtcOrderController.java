...
import com.manage.biz.service.GOtcOrderService;
...
public class OtcOrderController{
    ...
    private GOtcOrderService otcOrderService;
    ...
    public Map<String, Object> list(HttpServletRequest request, HttpServletResponse response, Model model,
                       @FormModel("otcOrderVO") GOtcOrderVO otcOrderVO) throws Exception {
        if (otcOrderVO == null) {
            otcOrderVO = new GOtcOrderVO();
        }
