...
import com.manage.biz.service.GCurrencyService;
...
public class GCurrencyController{
    ...
    public String toUpdate(HttpServletRequest request, HttpServletResponse response, Model model, @RequestParam(name="id") String currency_id) throws Exception {
    ...
    public Map<String, Object> delete(HttpServletRequest request, HttpServletResponse response, Model model,
                         @RequestParam(name = "id") String currency_id) throws Exception {
        Map<String, Object> jsonMap = new HashMap<String, Object>();
        try{
    ...
    public String info(HttpServletRequest request, HttpServletResponse response, Model model,@RequestParam(name="id") String currency_id) throws Exception {
