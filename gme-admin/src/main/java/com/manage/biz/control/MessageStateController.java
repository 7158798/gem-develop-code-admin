 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/biz/messageState")
public class MessageStateController{
	private static final Log log = LogFactory.getLog(MessageStateController.class);

    @Resource(name = "MessageStateService")
    private MessageStateService messageStateService;

	/**
     * 去分页
     */
    @RequiresPermissions("biz:messageState:view")
    @RequestMapping(value = "toList")
    public String toList(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
    	return "modules/biz/messageStateList";
    }
    /**
     * 分页
     */
    ...
    public Map<String, Object> list(HttpServletRequest request, HttpServletResponse response, Model model,
        ...
        if (request.getParameter("page") != null) {
            ...
            messageStateVO.setRows(Integer.parseInt(request.getParameter("rows")));
        }
    ...
    public Map<String, Object> add(HttpServletRequest request, HttpServletResponse response, Model model,
                      @FormModel("g_messageState") GMessageState g_messageState) throws Exception {
        Map<String, Object> jsonMap = new HashMap<String, Object>();
        try{
        	boolean result = messageStateService.add(g_messageState);
	        if (result) {
     ...
     * 去修改
     */
    /*@RequiresPermissions("biz:messageState:update")
    ...
    public String toUpdate(HttpServletRequest request, HttpServletResponse response, Model model, java.lang.String id) throws Exception {
        model.addAttribute("item", messageStateService.get(id));
        return "modules/biz/messageStateUpdate";
    }*/
    ...
    public Map<String, Object> update(HttpServletRequest request, HttpServletResponse response, Model model,
        ...
        Map<String, Object> jsonMap = new HashMap<String, Object>();
        try{
        	boolean result = messageStateService.update(g_messageState);
	        if (result) {
	            jsonMap.put("success", true);
	            jsonMap.put("msg", "操作成功");
	        } else {
     ...
     * 删除
     */
    /*@RequiresPermissions("biz:messageState:delete")
    ...
    public Map<String, Object> delete(HttpServletRequest request, HttpServletResponse response, Model model,
        ...
        Map<String, Object> jsonMap = new HashMap<String, Object>();
        try{
        	boolean result = messageStateService.delete(id);
	        if (result) {
	            jsonMap.put("success", true);
	            jsonMap.put("msg", "操作成功");
	        } else {
    ...
    public String info(HttpServletRequest request, HttpServletResponse response, Model model, @RequestParam(name = "id") String id) throws Exception {
        model.addAttribute("item", messageStateService.get(request,id));
        return "modules/biz/messageStateInfo";
    }
}
