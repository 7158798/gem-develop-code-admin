...
功能描述：存储用户账户信息。新增</title>
  ...
  <body>
  	<form id="formobj" action="${ctx}/bus/g_account/add" name="formobj" method="post" class="form-horizontal">
 		<input type="hidden" id="btn_sub" class="btn_sub">
 		<div class="control-group">
        	<label class="control-label Validform_label">账号ID；用户账号ID，全局唯一<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.account_id" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">真实姓名<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.real_name" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">银行卡类型；1-借记卡;2-信用卡;<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.card_type" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">银行卡号<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.card_number" value="" class="inputxt" datatype="*1-50"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">开户银行<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.bank_name" value="" class="inputxt" datatype="*1-50"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">开户支行<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.bank_branch_name" value="" class="inputxt" datatype="*1-50"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">支付宝二维码图片编号<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.alipay_qrcode_id" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">支付宝账号<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.alipay_account" value="" class="inputxt" datatype="*1-50"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">支付宝绑定描述<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.alipay_desc" value="" class="inputxt" datatype="*1-300"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">微信钱包二维码图片编号<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.wx_qrcode_id" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">微信账号<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.wx_account" value="" class="inputxt" datatype="*1-50"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">微信绑定描述<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.wx_desc" value="" class="inputxt" datatype="*1-300"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">转账账号1-未审核;2-通过审核;<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.audit_status" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">账户状态1-正常;2-冻结;<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.account_status" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input name="g_account.token" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">备注<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.remark" value="" class="inputxt" datatype="*1-50"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">数据表版本,默认1<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.version" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">创建时间格式:yyyy-MM-dd HH:ss:mm<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.create_time" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">更新时间格式:yyyy-MM-dd HH:ss:mm<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_account.updated_time" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
	</form>
  </body>
