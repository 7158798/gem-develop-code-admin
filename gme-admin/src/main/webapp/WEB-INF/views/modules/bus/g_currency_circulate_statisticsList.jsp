...
<head>
	...
	<script type="text/javascript">
	  	$(function() {
	  		$('#dataGrid').datagrid({
				url : '${ctx}/bus/g_currency_circulate_statistics/list',
				method: 'POST',
				title : '',
				iconCls : '',
				fit : true,
					...
					},
				{
					...
					formatter:function (value, row, index){
						...
						<shiro:hasPermission name="bus:g_currency_circulate_statistics:update">
							b = '<li><a href="javaScript:void(0);" onclick="update(\'修改\',\'${ctx}/bus/g_currency_circulate_statistics/toUpdate?id='+row.volume_id+'\',\'dataGrid\',null,null);"><i class="fa fa-edit"></i>修改</a></li>';
						</shiro:hasPermission>
						<shiro:hasPermission name="bus:g_currency_circulate_statistics:delete">
							c = '<li><a href="javaScript:void(0);" onclick="deleterow('+row.volume_id+')"><i class="fa fa-trash-o"></i>删除</a></li>';
						</shiro:hasPermission>
  		...
  		function deleterow(id){
            createdialog('删除确认 ', '确定删除该记录吗 ?', '${ctx}/bus/g_currency_circulate_statistics/delete?id='+id,'dataGrid');
        }
  		function bustripsearch(){
			...
			$('#dataGrid').datagrid({url:'${ctx}/bus/g_currency_circulate_statistics/list',pageNumber:1});
		}
		function searchReset(){ 
			$("#toolDivNew").find(":input").val("");bustripsearch();
		}
		function toAdd(){
			add('新增','${ctx}/bus/g_currency_circulate_statistics/toAdd','dataGrid',800,500);
		}
	</script>
  </head>
   <body class="psflow-panpel-body">
		...
		<div id="toolDiv" style="padding:2px 5px;">
			<div class="psflow-panpel-maintitle">
				<h2 class="psflow-panpel-title"><span>币种流通统计</span></h2>
			</div>
			<div class="psflow-panpel-tooldiv">
				<div class="tooldiv" id="toolDivNew">
		   			...
		   			<span>币种编号:</span><input type="text" name="g_currency_circulate_statistics_vo.currency_id" >
		   			<span>币种代码:</span><input type="text" name="g_currency_circulate_statistics_vo.currency_symbol" >
