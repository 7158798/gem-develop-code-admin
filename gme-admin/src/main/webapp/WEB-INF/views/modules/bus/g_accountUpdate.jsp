...
<html>
  ...
  <body>
  	<form id="formobj" action="${ctx}/bus/g_account/update" name="formobj" method="post" class="form-horizontal">
 		<input type="hidden" id="btn_sub" class="btn_sub">
 		<div class="control-group">
        	<label class="control-label Validform_label">转账账号<font color='red'>*</font>：</label>
	        <div class="controls">
		        <select name="g_account.audit_status">
 		...
 		<div class="control-group">
	        ...
	        <div class="controls">
	         	<select name="g_account.account_status">
 		...
 		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input name="g_account.remark" value="${item.remark}" class="inputxt"  datatype="*1-50"  type="text">
	        </div>
      	</div>
		<input type="hidden" name="g_account.uid" value="${item.uid}"/>
	</form>
  </body>
</html>
