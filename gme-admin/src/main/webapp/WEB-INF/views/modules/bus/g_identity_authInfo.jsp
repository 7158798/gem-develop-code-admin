  ...
  <body>
  	<div class="form-horizontal">
  		...
  		<div class="control-group">
	        ...
	        <div class="controls">
	        	...
	        	<c:if test="${item.certificate_type==4}">
	        		<input disabled="disabled" value="台湾居民通行证" class="inputxt" type="text">
	        	</c:if>
	        	<c:if test="${item.certificate_type==5}">
	        		<input disabled="disabled" value="港澳居民通行证" class="inputxt" type="text">
	        	</c:if>
	        </div>
      	</div>
  		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input disabled="disabled" value="${item.certificate_number}" class="inputxt" type="text">
	        </div>
      	</div>
  		<div class="control-group">
  		...
  		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input disabled="disabled" value="${item.reverse_img_id}" class="inputxt" type="text">
	        </div>
      	</div>
      	<div class="control-group">
        	<label class="control-label Validform_label">证件背面图片：</label>
	        <div class="controls">
	        	<img alt="reverse" src="${item.reverse_img}" width="100px" height="100px">
	        </div>
      	</div>
  		<div class="control-group">
        	<label class="control-label Validform_label">证件正面图片编号：</label>
	        <div class="controls">
	        	<input disabled="disabled" value="${item.front_img_id}" class="inputxt" type="text">
	        </div>
      	</div>
      	<div class="control-group">
  		...
  		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input disabled="disabled" value="${item.in_hand_img_id}" class="inputxt" type="text">
	        </div>
      	</div>
      	<div class="control-group">
        	<label class="control-label Validform_label">手持证件图片：</label>
	        <div class="controls">
	        	<img alt=in_hand src="${item.in_hand_img}" width="100px" height="100px">
	        </div>
      	</div>
  		<div class="control-group">
	        ...
	        <div class="controls">
	        	...
	        	<c:if test="${item.auth_status == 3}">
	        		<input disabled="disabled" value="已通过认证" class="inputxt" type="text">
	        	</c:if>
	        	<c:if test="${item.auth_status == 4}">
	        		<input disabled="disabled" value="未通过认证" class="inputxt" type="text">
	        	</c:if>
	        </div>
      	</div>
  		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input disabled="disabled" value="${item.feedback}" class="inputxt" type="text">
	        </div>
      	</div>
  		<div class="control-group">
