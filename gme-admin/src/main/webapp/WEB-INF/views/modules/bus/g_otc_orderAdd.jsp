...
新增</title>
  ...
  <body>
  	<form id="formobj" action="${ctx}/bus/g_otc_order/add" name="formobj" method="post" class="form-horizontal">
 		<input type="hidden" id="btn_sub" class="btn_sub">
 		<div class="control-group">
        	<label class="control-label Validform_label">订单号;无重复32位订单号<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.order_id" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">挂单用户编号<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.uid" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">业务类型:1-买家;2-卖家;<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.order_type" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">媒介币种<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.currency_id" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">人民币价格<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.order_price" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">数量<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.order_number" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">总金额<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.order_amount" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">订单状态：1挂单中;2-全部成交;3-部分成交;4-撤销;5-挂单超时;<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.order_status" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">注意，解决僵尸单方案：如果遇到最后数量余额小于该字段设置的最小交易数量则自动默认成交,不受该字段限制;<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.order_min_number" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input name="g_otc_order.order_pay_type" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">挂单时长限制（单位：小时）默认0表示无限制<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.order_duration" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">备注<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.remark" value="" class="inputxt" datatype="*1-50"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">数据表版本,默认1<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.version" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">创建时间格式:yyyy-MM-dd HH:ss:mm<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.create_time" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">更新时间格式:yyyy-MM-dd HH:ss:mm<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_otc_order.updated_time" value="" class="inputxt" datatype="*1-"  type="text">
	        </div>
      	</div>
	</form>
  </body>
