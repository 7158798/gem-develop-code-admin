  		...
  		<div class="easyui-tabs" data-options="tabWidth:112" style="width:100%;height:100%">
			<div title="编辑菜单" style="padding:10px">
				<div class="tabs-menu-box">
					<form id="formobj" action="${ctx}/sys/sysMenu/update" name="formobj" method="post" class="form-horizontal">
				 		<input type="hidden" id="btn_sub" class="btn_sub">
				 		<div class="control-group">
				        	<label class="control-label Validform_label">菜单名<font color="red">*</font>：</label>
					        <div class="controls">
					          	<input name="sysMenu.menuname" value="${item.menuname}" datatype="*1-200" class="inputxt" type="text">
					        </div>
				      	</div>
				      	<div class="control-group">
				        	<label class="control-label Validform_label">菜单地址：</label>
					        <div class="controls">
					          	<input name="sysMenu.menuurl" value="${item.menuurl}" datatype="*0-200" class="inputxt" type="text">
					        </div>
				      	</div>
				      	<div class="control-group">
					        ...
					        <div class="controls">
					          	<input name="sysMenu.menusortno" value="${item.menusortno}" datatype="n" class="inputxt" type="text">
					        </div>
				      	</div>
				 		<div class="control-group">
				      		<label class="control-label Validform_label">
					        ...
					        <div class="controls">
					          	<select name="sysMenu.menufatherid"  class="select">
				      	...
				      	<div class="control-group">
					        ...
					        <div class="controls">
					          	<select name="sysMenu.isshow" class="select">
				      	...
				      	<div class="control-group">
					        ...
					        <div class="controls">
					          	<input name="sysMenu.ico" readonly="readonly" class="inputxt fonttype" value="${item.ico}" datatype="*0-100" class="inputxt" id="fontTypetype">
					        </div>
				      	</div>
						<input type="hidden" name="sysMenu.id" value="${item.id}" />
					</form>
				</div>
			</div>
						...
						<div id="toolDiv" style="padding:2px 5px;">
							<div class="form-horizontal">
								<div class="control-group">
							        ...
							        <div class="controls">
							          	<input name="sysPersion.persion" value="" id="persion" datatype="*1-200" class="inputxt" type="text">
							        </div>
						      	</div>
						      	<div class="control-group">
						        	<label class="control-label Validform_label">权限描述<font color='red'>*</font>：</label>
							        <div class="controls">
							          	<input name="sysPersion.persiondec" id="persiondec" value="" datatype="*1-200" class="inputxt" type="text">
							        </div>
						      	</div>
						      	<div class="control-group">
						      		<label class="control-label Validform_label">
        ...
        $(".fatype a").on('click', function() {
	  	 ...
	  	 $("#toolDiv").Validform({
			  ...
			  beforeSubmit:function(curform){
			  	var postData="sysPersion.mid=${item.id}&sysPersion.persion="+$("#persion").val()+"&sysPersion.persiondec="+$("#persiondec").val();
			  	$.ajax({
					async : false,
					cache : false,
					type : 'POST',
					data:postData,
					url : '${ctx}/sys/sysPersion/add',
					error : function() {
					},
		  ...
		  $("#formobj").Validform({
			...
			$("#dataGrid1").datagrid({
		        ...
		        fitColumns : true,
		        toolbar:'#toolDiv',
		        url:'${ctx}/sys/sysPersion/list?sysPersionVO.mid=${item.id}',
		        columns: [[
		            ...
		            { field: '_opt', title: '操作', width: 200,
			            formatter:function (value, row, index){	
			            	return '<a href="javaScript:void(0);" onclick="createDeleteDialog( \'${ctx}/sys/sysPersion/delete?id='+row.id+'\');">[删除]</a>';
			            }
		            }
		        ]],
