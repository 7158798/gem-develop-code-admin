  ...
  <head>
	...
	<script type="text/javascript">
	  		...
	  		$('#dataGrid').treegrid({
				...
				},
				{
					...
					formatter:function (value, row, index){
						...
						tin++;
						<shiro:hasPermission name="sys:sysMenu:view">
							a = '<li><a href="javaScript:void(0);" onclick="detail(\'详情\',\'${ctx}/sys/sysMenu/info?id='+row.id+'\',null,null)"><i class="fa fa-info-circle"></i>详情</a></li>';
						</shiro:hasPermission>
						<shiro:hasPermission name="sys:sysMenu:update">
							b = '<li><a href="javaScript:void(0);" onclick="update(\'修改\',\'${ctx}/sys/sysMenu/toUpdate?id='+row.id+'\',\'dataGrid\',null,null)"><i class="fa fa-edit"></i>修改</a></li>';
						</shiro:hasPermission>
        ...
        function deleterow(id){
            createdialog('删除确认 ', '确定删除该记录吗 ?', '${ctx}/sys/sysMenu/delete?id='+id,'dataGrid');
        }
		...
		<div id="toolDiv" style="padding:2px 5px;">
			...
			<div class="psflow-panpel-tooldiv">
				<div class="tooldiv" id="toolDivNew">
					<shiro:hasPermission name="sys:sysMenu:add">
						<a href="javaScript:void(0);" class="u-btn u-btn-cg" plain="true" id="addBtn" onclick="add('新增','${ctx}/sys/sysMenu/toAdd','dataGrid',null,null);"><i class="fa fa-fw fa-plus"></i>添加</a>
					</shiro:hasPermission>
				</div>
			</div>
		</div>
