...
<html lang="zh-cn">
  ...
  <body>
  	<form id="formobj" action="${ctx}/sys/sysMenu/add" name="formobj" method="post" class="form-horizontal">
  		<input type="hidden" id="btn_sub" class="btn_sub">
      	<div class="control-group">
        	<label class="control-label Validform_label">菜单名<font color="red">*</font>：</label>
	        <div class="controls">
	          	<input name="sysMenu.menuname" value="" datatype="*1-200" class="inputxt" type="text">
	        </div>
      	</div>
      	<div class="control-group">
        	<label class="control-label Validform_label">菜单地址：</label>
	        <div class="controls">
	          	<input name="sysMenu.menuurl" value="" datatype="*0-200" class="inputxt" type="text">
	        </div>
      	</div>
      	<div class="control-group">
	        ...
	        <div class="controls">
	          	<input name="sysMenu.menusortno" value="" datatype="n" class="inputxt" type="text">
	        </div>
      	</div>
 		<div class="control-group">
      		<label class="control-label Validform_label">
      	...
      	<div class="control-group">
	        ...
	        <div class="controls">
	          	<input name="sysMenu.ico" readonly="readonly" value="" class="inputxt fonttype" datatype="*0-100" type="text" id="fontTypetype">
	        </div>
      	</div>
	</form>
	<div id="fontTypeBox">
