  ...
  <head>
    ...
    <script type="text/javascript">  
	    ...
	    $(function() {  
	          ...
	          editor.html(document.getElementById("content_bak").value);
	    });  
	</script> 
  </head>
  <body>
  	<div class="form-horizontal">
  		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input disabled="disabled" value="${item.subject_id}" class="inputxt" type="text">
	        </div>
      	</div>
  		<div class="control-group">
        	<label class="control-label Validform_label">答复内容：</label>
	        <div class="controls">
	       		<input name="content_bak" id="content_bak" disabled="disabled" value="${item.content}" class="inputxt" type="hidden">
  		...
  		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input disabled="disabled" value="${item.reply_img_id}" class="inputxt" type="text">
	        </div>
      	</div>
      	<div class="control-group">
