...
<html>
  ...
  <body>
  	<form id="formobj" action="${ctx}/biz/user/update" name="formobj" method="post" class="form-horizontal">
 		...
 		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input name="user.remark" value="${item.remark}" class="inputxt"  datatype="*1-50"  type="text">
	        </div>
      	</div>
		<input type="hidden" name="user.uid" value="${item.uid}"/>
	</form>
  </body>
</html>
