...
<body>
	<div class="form-horizontal">
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.pairSn}" class="inputxt"
					type="text">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.pairSymbol}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.pairDesc}" class="inputxt"
					type="text">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.currencyId}"
					class="inputxt" type="text">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.serviceCharge}"
					class="inputxt" type="text">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.currencyTokenId}"
					class="inputxt" type="text">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.tokenServiceCharge}"
					class="inputxt" type="text">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.tradeMaxPrice}"
					class="inputxt" type="text">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.tradeMinPrice}"
					class="inputxt" type="text">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.tradeNumberLowerLimit}"
					class="inputxt" type="text">
			</div>
		</div>
		<div class="control-group">
