...
<body>
	<div class="form-horizontal">
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.currencySn}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.currencySymbol}"
					class="inputxt" type="text">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input disabled="disabled" value="${item.currencyDesc}"
					class="inputxt" type="text">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<div class="controls">
					<a href="${item.iconUrl}" target="_blank"><img
						src="${item.iconPreviewUrl}" width="100px" height="100px"></a>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label Validform_label">中文名：</label>
				<div class="controls">
					<input disabled="disabled" value="${item.nameCN}" class="inputxt"
						type="text">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input disabled="disabled" value="${item.nameEN}" class="inputxt"
						type="text">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input disabled="disabled" value="${item.enableTime}"
						class="inputxt" type="text">
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input disabled="disabled" value="${item.operatorUid}"
						class="inputxt" type="text">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input disabled="disabled" value="${item.operatorName}"
						class="inputxt" type="text">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input disabled="disabled" value="${item.currencyConfigId}"
						class="inputxt" type="text">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					...
					<c:if test="${item.isOpen == '0101'}">
						<input disabled="disabled" value="充值&提现" class="inputxt"
							type="text">
					</c:if>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input disabled="disabled" value="${item.supply}" class="inputxt"
						type="text">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input disabled="disabled" value="${item.circulation}"
						class="inputxt" type="text">
				</div>
			</div>
			<div class="control-group">
