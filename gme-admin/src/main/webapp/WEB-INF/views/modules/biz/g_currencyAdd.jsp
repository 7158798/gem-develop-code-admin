  ...
  <body>
  	<form id="formobj" action="${ctx}/bus/g_currency/add" name="formobj" method="post" class="form-horizontal">
 		...
 		<div class="control-group">
	        ...
	        <div class="controls">
	        	<input name="g_currency.supply" value="" class="inputxt" datatype="n1-16"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
        	<label class="control-label Validform_label">流通总量<font color='red'>*</font>：</label>
	        <div class="controls">
	        	<input name="g_currency.circulation" value="" class="inputxt" datatype="n1-16"  type="text">
	        </div>
      	</div>
 		<div class="control-group">
